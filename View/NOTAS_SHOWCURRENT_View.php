...
function render(){ 
              ...
              ?>  
                ...
                <h1><?php echo $strings['Detalle'] . ' NOTAS' ?></h1>
...
COMPARTIDO:<input type ='text' name ='COMPARTIDO' size='200'  value='<?php echo ($this->valores['COMPARTIDO']); ?>' onblur='esVacio(this)  && comprobarText(this,200)' required readonly ><br>
